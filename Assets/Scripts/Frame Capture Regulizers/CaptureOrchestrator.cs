...
public class CaptureOrchestrator : MonoBehaviour
{
    ...
    [SerializeField]
    private int saveRateInSeconds = 10;
    ...
    */
     ...
     IEnumerator capture(){
        ...
        while(time % saveRateInSeconds != 0){} //this can be enhanced. This can cause some skipped periodic captures
        
        printHandDataAsJSON(time);
        printData(time);
        yield return null;
    }
